...
""")
    ...
    @Query("""
    	    SELECT o
    	    FROM Order o
    	    WHERE o.deliveryDriver.driverId = :driverId
    	""")
    	List<Order> findByDeliveryDriver_DriverId(@Param("driverId") Integer driverId);
    ...
    @Query("""
    	...
    	""")
    	    ...
    	    WHERE o.deliveryDriver.driverId = :driverId
    	""")
    	    List<Order> findByDeliveryDriverByDriverId(@Param("driverId") Integer driverId);
}
